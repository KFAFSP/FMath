...
{
    /// <summary>
    /// Abstract generic base class for vector proxies that produce a new matrix.
    /// </summary>
    ...
    public abstract class VectorMatrixProxy<TData> :
        VectorProxy,
        IMutableMatrix<TData>,
        IFormattable
    {
        protected VectorMatrixProxy(IVector ABaseVector)
            : base(ABaseVector)
        { }
